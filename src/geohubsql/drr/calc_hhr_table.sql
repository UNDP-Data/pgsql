...
CREATE OR REPLACE FUNCTION drr.calc_hhr_table(
    ...
    RETURNS TABLE (gdlcode TEXT, hazard_index FLOAT, vulnerability_index FLOAT, exposure_index FLOAT, heat_health_risk_index FLOAT) AS $$
...
-- PL/PgSQL function to calculate the Heat Heath Risk
	...
	BEGIN
        ...
        SELECT
            ...
            ht2.exposure_index,
            ( ht2.hazard_index * 0.22 + ht2.vulnerability_index * 0.33 + ht2.exposure_index * 0.44 ) * 100 AS heat_health_risk_index
