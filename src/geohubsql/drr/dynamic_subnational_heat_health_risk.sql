    ...
    params varchar default '{
              ...
              "hdi_adjustment":
                { "id":"hdi_adjustment",
                  ...
                  "hidden":0,
                  "units":"percent"},
              "dependency_ratio_adjustment":
                { "id":"dependency_ratio_adjustment",
                  "param_name":"dependency_ratio_adjustment",
                  "type":"numeric",
                  "icon":"fa-graduation-cap",
                  "limits":{"min":-10,"max":10},
                  "abs_limits":{"min":0,"max":1},
                  "value":0,
                  "label":"Adjustment of the Dependency Ratio",
                  "widget_type":"slider",
                  "hidden":0,
                  "units":"percent"},
              "gnipc_adjustment":
...
-- Notes:
-- dependency_ratio = 1 / population(15_64)
-- population(15_64) = 1 / (1 + dependency_ratio)
...
RETURNS bytea AS $$
    ...
    DECLARE
        ...
        dependency_ratio_adjustment float default 0;
        ...
        dependency_ratio_min float default 0;
        ...
        dependency_ratio_max float default 0;
        ...
        dependency_ratio_value float default 0;
...
--		RAISE WARNING 'sanitized_json -> max_t_adjustment -> value: %',  sanitized_json->'max_t_adjustment'->'value';
        ...
        dependency_ratio_adjustment  := sanitized_json->'dependency_ratio_adjustment'->'value';
        ...
        dependency_ratio_min    := (func_defaults->'dependency_ratio_min'->'abs_limits'->'min')::float;
        ...
        dependency_ratio_max    := (func_defaults->'dependency_ratio_max'->'abs_limits'->'max')::float;
        ...
        --RAISE WARNING 'max_t_adjustment: %, hdi_adjustment: %, dependency_ratio_adjustment: %, gnipc_adjustment %, vhi_adjustment %, pop_density_adjustment %', max_t_adjustment, hdi_adjustment, dependency_ratio_adjustment, gnipc_adjustment, vhi_adjustment, pop_density_adjustment;
...
--dependency_ratio_adjustment	%	-10	10  **recalc dependency ratio
...
--pop_density_adjustment	%	-10	10
        ...
        CREATE TEMPORARY TABLE hhr_extarg_tmp_table_simpl AS (
            ...
            admin.utils_enforce_limits(h."dependency_ratio"     * dependency_ratio_adjustment/100,  dependency_ratio_min,   dependency_ratio_max)::decimal AS dependency_ratio,
			...
			drr.calc_hhr(
			                ...
			                admin.utils_enforce_limits(h."dependency_ratio"     * dependency_ratio_adjustment/100,  dependency_ratio_min,   dependency_ratio_max)::decimal,
...
--        RAISE WARNING 'Using simplified table %', simplified_table_name;
        ...
        EXECUTE format('CREATE TEMPORARY TABLE mvtgeom AS (
			...
			CAST(h.hdi as FLOAT),
			CAST(h.dependency_ratio as FLOAT),
...
-- works in QGIS:
-- http://172.18.0.6:7800/drr.dynamic_subnational_hhr/{z}/{x}/{y}.pbf?params={ "max_t_adjustment": {"value":5}, "hdi_adjustment": {"value":3}, "dependency_ratio_adjustment": {"value":4}, "gnipc_adjustment": {"value":5000}, "vhi_adjustment": {"value":6}, "pop_density_adjustment": {"value":7} }
