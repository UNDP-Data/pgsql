...
tippecanoe  --layer=adm0_polygons  --maximum-zoom=6 --simplify-only-low-zooms  --detect-shared-borders  --read-parallel  --no-tile-size-limit  --no-tile-compression  --force  --output-to-directory="$hrea_outputs"pbfs/adm0_polygons/  "$hrea_outputs"GeoJSON/adm0_polygons.geojsonl --include=adm0_id  --include=adm0_name  --include=pop  --include=hrea_2020  --include=hrea_2019  --include=hrea_2018  --include=hrea_2017  --include=hrea_2016  --include=hrea_2015  --include=hrea_2014  --include=hrea_2013  --include=hrea_2012

tippecanoe  --layer=adm1_polygons  --maximum-zoom=6 --simplify-only-low-zooms  --detect-shared-borders  --read-parallel  --no-tile-size-limit  --no-tile-compression  --force  --output-to-directory="$hrea_outputs"pbfs/adm1_polygons/  "$hrea_outputs"GeoJSON/adm1_polygons.geojsonl --include=adm0_id  --include=adm0_name  --include=adm1_id  --include=adm1_name  --include=pop  --include=hrea_2020  --include=hrea_2019  --include=hrea_2018  --include=hrea_2017  --include=hrea_2016  --include=hrea_2015  --include=hrea_2014  --include=hrea_2013  --include=hrea_2012

tippecanoe  --layer=adm2_polygons  --maximum-zoom=6 --simplify-only-low-zooms  --detect-shared-borders  --read-parallel  --no-tile-size-limit  --no-tile-compression  --force  --output-to-directory="$hrea_outputs"pbfs/adm2_polygons/  "$hrea_outputs"GeoJSON/adm2_polygons.geojsonl --include=adm0_id  --include=adm0_name  --include=adm1_id  --include=adm1_name  --include=adm2_id  --include=adm2_name  --include=pop  --include=hrea_2020  --include=hrea_2019  --include=hrea_2018  --include=hrea_2017  --include=hrea_2016  --include=hrea_2015  --include=hrea_2014  --include=hrea_2013  --include=hrea_2012
