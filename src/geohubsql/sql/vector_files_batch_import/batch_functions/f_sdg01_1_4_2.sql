CREATE OR REPLACE FUNCTION sdg01.f_1_4_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"sex_code": {"options": ["F", "_T"], "value": "F"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg01.f_1_4_2';
...
--        RAISE WARNING 'JSON: %',my_query;
        ...
        SELECT format('CREATE TEMPORARY TABLE sdg_tmp_table AS (
            SELECT
			a."iso3cd" AS iso3cd
			, a.value_2013 , a.value_2017 , a.value_2012 , a.value_2011 , a.value_2014 , a.value_2018 , a.value_2015 , a.value_2016 
             , a.value_latest 
			FROM sdg01.admin0 a
			WHERE
    			indicator = ''1.4.2''
...
--        RAISE WARNING 'Using simplified table %', simplified_table_name;
        ...
        EXECUTE format('CREATE TEMPORARY TABLE mvtgeom AS (
			...
			a.iso3cd
            , CAST(h.value_2013 as FLOAT) , CAST(h.value_2017 as FLOAT) , CAST(h.value_2012 as FLOAT) , CAST(h.value_2011 as FLOAT) , CAST(h.value_2014 as FLOAT) , CAST(h.value_2018 as FLOAT) , CAST(h.value_2015 as FLOAT) , CAST(h.value_2016 as FLOAT) 
...
COMMENT ON FUNCTION sdg01.f_1_4_2 IS 'This is f_1_4_2
';

--SELECT * FROM "sdg01"."f_1_4_2"(0,0,0,'{"subsets":
--    {"sex_code": {"options": ["F", "_T"], "value": "F"}}
--    }') AS OUTP;