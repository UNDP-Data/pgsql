CREATE OR REPLACE FUNCTION sdg01.f_1_5_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg01.f_1_5_2';
...
COMMENT ON FUNCTION sdg01.f_1_5_2 IS 'This is f_1_5_2
';

--SELECT * FROM "sdg01"."f_1_5_2"(0,0,0,'{"subsets":
--    {}
--    }') AS OUTP;