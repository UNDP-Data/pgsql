CREATE OR REPLACE FUNCTION sdg02.f_2_2_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg02.f_2_2_1';
...
COMMENT ON FUNCTION sdg02.f_2_2_1 IS 'This is f_2_2_1
';

--SELECT * FROM "sdg02"."f_2_2_1"(0,0,0,'{"subsets":
--    {"age_code": {"options": ["Y0T4"], "value": "Y0T4"}}
--    }') AS OUTP;