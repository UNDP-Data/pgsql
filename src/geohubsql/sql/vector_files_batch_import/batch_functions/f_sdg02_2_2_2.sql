CREATE OR REPLACE FUNCTION sdg02.f_2_2_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"age_code": {"options": ["Y0T4"], "value": "Y0T4"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg02.f_2_2_2';
...
COMMENT ON FUNCTION sdg02.f_2_2_2 IS 'This is f_2_2_2
';

--SELECT * FROM "sdg02"."f_2_2_2"(0,0,0,'{"subsets":
--    {"age_code": {"options": ["Y0T4"], "value": "Y0T4"}}
--    }') AS OUTP;