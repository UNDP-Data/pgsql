CREATE OR REPLACE FUNCTION sdg02.f_2_2_3(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg02.f_2_2_3';
...
COMMENT ON FUNCTION sdg02.f_2_2_3 IS 'This is f_2_2_3
';

--SELECT * FROM "sdg02"."f_2_2_3"(0,0,0,'{"subsets":
--    {"age_code": {"options": ["Y15T49"], "value": "Y15T49"}, "sex_code": {"options": ["F"], "value": "F"}}
--    }') AS OUTP;