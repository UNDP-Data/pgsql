CREATE OR REPLACE FUNCTION sdg02.f_2_3_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg02.f_2_3_2';
...
COMMENT ON FUNCTION sdg02.f_2_3_2 IS 'This is f_2_3_2
';

--SELECT * FROM "sdg02"."f_2_3_2"(0,0,0,'{"subsets":
--    {"sex_code": {"options": ["M", "_T", "F"], "value": "M"}}
--    }') AS OUTP;