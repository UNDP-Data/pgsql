CREATE OR REPLACE FUNCTION sdg03.f_3_1_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg03.f_3_1_1';
...
COMMENT ON FUNCTION sdg03.f_3_1_1 IS 'This is f_3_1_1
';

--SELECT * FROM "sdg03"."f_3_1_1"(0,0,0,'{"subsets":
--    {"sex_code": {"options": ["F"], "value": "F"}}
--    }') AS OUTP;