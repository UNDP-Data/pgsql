CREATE OR REPLACE FUNCTION sdg03.f_3_2_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"age_code": {"options": ["M0"], "value": "M0"}, "sex_code": {"options": ["_T"], "value": "_T"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg03.f_3_2_2';
...
COMMENT ON FUNCTION sdg03.f_3_2_2 IS 'This is f_3_2_2
';

--SELECT * FROM "sdg03"."f_3_2_2"(0,0,0,'{"subsets":
--    {"age_code": {"options": ["M0"], "value": "M0"}, "sex_code": {"options": ["_T"], "value": "_T"}}
--    }') AS OUTP;