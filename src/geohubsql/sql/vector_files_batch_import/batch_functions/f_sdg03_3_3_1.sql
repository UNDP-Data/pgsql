CREATE OR REPLACE FUNCTION sdg03.f_3_3_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"age_code": {"options": ["Y15T49", "_T", "Y0T14", "Y_GE50", "Y15T24"], "value": "Y15T49"}, "sex_code": {"options": ["M", "_T", "F"], "value": "M"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg03.f_3_3_1';
...
COMMENT ON FUNCTION sdg03.f_3_3_1 IS 'This is f_3_3_1
';

--SELECT * FROM "sdg03"."f_3_3_1"(0,0,0,'{"subsets":
--    {"age_code": {"options": ["Y15T49", "_T", "Y0T14", "Y_GE50", "Y15T24"], "value": "Y15T49"}, "sex_code": {"options": ["M", "_T", "F"], "value": "M"}}
--    }') AS OUTP;