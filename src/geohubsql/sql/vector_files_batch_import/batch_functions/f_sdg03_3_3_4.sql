CREATE OR REPLACE FUNCTION sdg03.f_3_3_4(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg03.f_3_3_4';
...
COMMENT ON FUNCTION sdg03.f_3_3_4 IS 'This is f_3_3_4
';

--SELECT * FROM "sdg03"."f_3_3_4"(0,0,0,'{"subsets":
--    {"age_code": {"options": ["Y0T4"], "value": "Y0T4"}}
--    }') AS OUTP;