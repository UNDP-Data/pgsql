CREATE OR REPLACE FUNCTION sdg03.f_3_7_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"age_code": {"options": ["Y15T49"], "value": "Y15T49"}, "sex_code": {"options": ["F"], "value": "F"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg03.f_3_7_1';
...
--        RAISE WARNING 'JSON: %',my_query;
        ...
        SELECT format('CREATE TEMPORARY TABLE sdg_tmp_table AS (
            SELECT
			a."iso3cd" AS iso3cd
			, a.value_2002 , a.value_2004 , a.value_2015 , a.value_2013 , a.value_2007 , a.value_2012 , a.value_2014 , a.value_2019 , a.value_2016 , a.value_2003 , a.value_2010 , a.value_2005 , a.value_2008 , a.value_2020 , a.value_2017 , a.value_2011 , a.value_2021 , a.value_2000 , a.value_2009 , a.value_2018 , a.value_2006 , a.value_2001 
             , a.value_latest 
			FROM sdg03.admin0 a
			WHERE
    			indicator = ''3.7.1''
...
COMMENT ON FUNCTION sdg03.f_3_7_1 IS 'This is f_3_7_1
';

--SELECT * FROM "sdg03"."f_3_7_1"(0,0,0,'{"subsets":
--    {"age_code": {"options": ["Y15T49"], "value": "Y15T49"}, "sex_code": {"options": ["F"], "value": "F"}}
--    }') AS OUTP;