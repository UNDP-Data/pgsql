CREATE OR REPLACE FUNCTION sdg03.f_3_b_3(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg03.f_3_b_3';
...
COMMENT ON FUNCTION sdg03.f_3_b_3 IS 'This is f_3_b_3
';

--SELECT * FROM "sdg03"."f_3_b_3"(0,0,0,'{"subsets":
--    {}
--    }') AS OUTP;