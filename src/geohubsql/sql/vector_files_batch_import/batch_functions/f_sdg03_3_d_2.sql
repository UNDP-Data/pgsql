CREATE OR REPLACE FUNCTION sdg03.f_3_d_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg03.f_3_d_2';
...
COMMENT ON FUNCTION sdg03.f_3_d_2 IS 'This is f_3_d_2
';

--SELECT * FROM "sdg03"."f_3_d_2"(0,0,0,'{"subsets":
--    {}
--    }') AS OUTP;