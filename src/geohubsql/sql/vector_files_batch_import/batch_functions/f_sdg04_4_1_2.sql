CREATE OR REPLACE FUNCTION sdg04.f_4_1_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"sex_code": {"options": ["M", "_T", "F"], "value": "M"}, "location": {"options": ["R", "_T", "U"], "value": "R"}, "education": {"options": ["ISCED11_3", "ISCED11_2", "ISCED11_1"], "value": "ISCED11_3"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg04.f_4_1_2';
...
--        RAISE WARNING 'JSON: %',my_query;
        ...
        SELECT format('CREATE TEMPORARY TABLE sdg_tmp_table AS (
            SELECT
			a."iso3cd" AS iso3cd
			, a.value_2002 , a.value_2004 , a.value_2015 , a.value_2013 , a.value_2007 , a.value_2012 , a.value_2014 , a.value_2019 , a.value_2016 , a.value_2003 , a.value_2010 , a.value_2005 , a.value_2008 , a.value_2017 , a.value_2011 , a.value_2000 , a.value_2009 , a.value_2018 , a.value_2006 , a.value_2001 
             , a.value_latest 
			FROM sdg04.admin0 a
			WHERE
    			indicator = ''4.1.2''
			AND a.sex_code = ''%s'' AND a.location = ''%s'' AND a.education = ''%s'' 
             AND a.value_latest IS NOT NULL 
        );'
        , sex_code , location , education 
        ) INTO my_query;
...
COMMENT ON FUNCTION sdg04.f_4_1_2 IS 'This is f_4_1_2
';

--SELECT * FROM "sdg04"."f_4_1_2"(0,0,0,'{"subsets":
--    {"sex_code": {"options": ["M", "_T", "F"], "value": "M"}, "location": {"options": ["R", "_T", "U"], "value": "R"}, "education": {"options": ["ISCED11_3", "ISCED11_2", "ISCED11_1"], "value": "ISCED11_3"}}
--    }') AS OUTP;