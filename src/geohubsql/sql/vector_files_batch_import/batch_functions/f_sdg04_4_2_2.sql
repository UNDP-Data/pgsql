CREATE OR REPLACE FUNCTION sdg04.f_4_2_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"sex_code": {"options": ["M", "_T", "F"], "value": "M"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg04.f_4_2_2';
...
COMMENT ON FUNCTION sdg04.f_4_2_2 IS 'This is f_4_2_2
';

--SELECT * FROM "sdg04"."f_4_2_2"(0,0,0,'{"subsets":
--    {"sex_code": {"options": ["M", "_T", "F"], "value": "M"}}
--    }') AS OUTP;