CREATE OR REPLACE FUNCTION sdg04.f_4_4_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"sex_code": {"options": ["M", "_T", "F"], "value": "M"}, "type_of_skill": {"options": ["SKILL_ICTCDV", "SKILL_ICTSFWR", "SKILL_ICTPST", "SKILL_ICTTRFF", "SKILL_ICTSSHT", "SKILL_ICTCPT", "SKILL_ICTCMFL", "SKILL_ICTATCH", "SKILL_ICTPRGM"], "value": "SKILL_ICTCDV"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg04.f_4_4_1';
...
--        RAISE WARNING 'JSON: %',my_query;
        ...
        SELECT format('CREATE TEMPORARY TABLE sdg_tmp_table AS (
            SELECT
			a."iso3cd" AS iso3cd
			, a.value_2017 , a.value_2014 , a.value_2018 , a.value_2019 , a.value_2015 , a.value_2016 
             , a.value_latest 
			FROM sdg04.admin0 a
			WHERE
    			indicator = ''4.4.1''
			AND a.sex_code = ''%s'' AND a.type_of_skill = ''%s'' 
             AND a.value_latest IS NOT NULL 
        );'
        , sex_code , type_of_skill 
        ) INTO my_query;
...
--        RAISE WARNING 'Using simplified table %', simplified_table_name;
        ...
        EXECUTE format('CREATE TEMPORARY TABLE mvtgeom AS (
			...
			a.iso3cd
            , CAST(h.value_2017 as FLOAT) , CAST(h.value_2014 as FLOAT) , CAST(h.value_2018 as FLOAT) , CAST(h.value_2019 as FLOAT) , CAST(h.value_2015 as FLOAT) , CAST(h.value_2016 as FLOAT) 
...
COMMENT ON FUNCTION sdg04.f_4_4_1 IS 'This is f_4_4_1
';

--SELECT * FROM "sdg04"."f_4_4_1"(0,0,0,'{"subsets":
--    {"sex_code": {"options": ["M", "_T", "F"], "value": "M"}, "type_of_skill": {"options": ["SKILL_ICTCDV", "SKILL_ICTSFWR", "SKILL_ICTPST", "SKILL_ICTTRFF", "SKILL_ICTSSHT", "SKILL_ICTCPT", "SKILL_ICTCMFL", "SKILL_ICTATCH", "SKILL_ICTPRGM"], "value": "SKILL_ICTCDV"}}
--    }') AS OUTP;