CREATE OR REPLACE FUNCTION sdg04.f_4_5_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"location": {"options": ["R", "_T", "U"], "value": "R"}, "education": {"options": ["ISCED11_3", "ISCED11_2", "ISCED11_1"], "value": "ISCED11_3"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg04.f_4_5_1';
...
--        RAISE WARNING 'JSON: %',my_query;
        ...
        SELECT format('CREATE TEMPORARY TABLE sdg_tmp_table AS (
			...
			WHERE
    			indicator = ''4.5.1''
			AND a.location = ''%s'' AND a.education = ''%s'' 
...
COMMENT ON FUNCTION sdg04.f_4_5_1 IS 'This is f_4_5_1
';

--SELECT * FROM "sdg04"."f_4_5_1"(0,0,0,'{"subsets":
--    {"location": {"options": ["R", "_T", "U"], "value": "R"}, "education": {"options": ["ISCED11_3", "ISCED11_2", "ISCED11_1"], "value": "ISCED11_3"}}
--    }') AS OUTP;