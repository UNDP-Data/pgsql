CREATE OR REPLACE FUNCTION sdg04.f_4_a_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"education": {"options": ["ISCED11_3", "ISCED11_2", "ISCED11_1"], "value": "ISCED11_3"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg04.f_4_a_1';
...
COMMENT ON FUNCTION sdg04.f_4_a_1 IS 'This is f_4_a_1
';

--SELECT * FROM "sdg04"."f_4_a_1"(0,0,0,'{"subsets":
--    {"education": {"options": ["ISCED11_3", "ISCED11_2", "ISCED11_1"], "value": "ISCED11_3"}}
--    }') AS OUTP;