CREATE OR REPLACE FUNCTION sdg04.f_4_b_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg04.f_4_b_1';
...
COMMENT ON FUNCTION sdg04.f_4_b_1 IS 'This is f_4_b_1
';

--SELECT * FROM "sdg04"."f_4_b_1"(0,0,0,'{"subsets":
--    {}
--    }') AS OUTP;