CREATE OR REPLACE FUNCTION sdg04.f_4_c_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"sex_code": {"options": ["M", "_T", "F"], "value": "M"}, "education": {"options": ["ISCED11_3", "ISCED11_02", "AGG_2_3", "ISCED11_2", "ISCED11_1"], "value": "ISCED11_3"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg04.f_4_c_1';
...
--        RAISE WARNING 'JSON: %',my_query;
        ...
        SELECT format('CREATE TEMPORARY TABLE sdg_tmp_table AS (
			...
			WHERE
    			indicator = ''4.c.1''
			AND a.sex_code = ''%s'' AND a.education = ''%s'' 
...
COMMENT ON FUNCTION sdg04.f_4_c_1 IS 'This is f_4_c_1
';

--SELECT * FROM "sdg04"."f_4_c_1"(0,0,0,'{"subsets":
--    {"sex_code": {"options": ["M", "_T", "F"], "value": "M"}, "education": {"options": ["ISCED11_3", "ISCED11_02", "AGG_2_3", "ISCED11_2", "ISCED11_1"], "value": "ISCED11_3"}}
--    }') AS OUTP;