CREATE OR REPLACE FUNCTION sdg05.f_5_2_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"age_code": {"options": ["Y_GE15", "Y15T49"], "value": "Y_GE15"}, "sex_code": {"options": ["F"], "value": "F"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg05.f_5_2_1';
...
COMMENT ON FUNCTION sdg05.f_5_2_1 IS 'This is f_5_2_1
';

--SELECT * FROM "sdg05"."f_5_2_1"(0,0,0,'{"subsets":
--    {"age_code": {"options": ["Y_GE15", "Y15T49"], "value": "Y_GE15"}, "sex_code": {"options": ["F"], "value": "F"}}
--    }') AS OUTP;