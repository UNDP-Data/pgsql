CREATE OR REPLACE FUNCTION sdg05.f_5_a_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg05.f_5_a_2';
...
COMMENT ON FUNCTION sdg05.f_5_a_2 IS 'This is f_5_a_2
';

--SELECT * FROM "sdg05"."f_5_a_2"(0,0,0,'{"subsets":
--    {}
--    }') AS OUTP;