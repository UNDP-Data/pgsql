CREATE OR REPLACE FUNCTION sdg06.f_6_2_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"location": {"options": ["R", "_T", "U"], "value": "R"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg06.f_6_2_1';
...
COMMENT ON FUNCTION sdg06.f_6_2_1 IS 'This is f_6_2_1
';

--SELECT * FROM "sdg06"."f_6_2_1"(0,0,0,'{"subsets":
--    {"location": {"options": ["R", "_T", "U"], "value": "R"}}
--    }') AS OUTP;