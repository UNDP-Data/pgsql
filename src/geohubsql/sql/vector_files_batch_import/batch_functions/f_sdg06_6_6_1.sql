CREATE OR REPLACE FUNCTION sdg06.f_6_6_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg06.f_6_6_1';
...
COMMENT ON FUNCTION sdg06.f_6_6_1 IS 'This is f_6_6_1
';

--SELECT * FROM "sdg06"."f_6_6_1"(0,0,0,'{"subsets":
--    {}
--    }') AS OUTP;