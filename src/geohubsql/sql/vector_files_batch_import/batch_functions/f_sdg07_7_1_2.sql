CREATE OR REPLACE FUNCTION sdg07.f_7_1_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg07.f_7_1_2';
...
COMMENT ON FUNCTION sdg07.f_7_1_2 IS 'This is f_7_1_2
';

--SELECT * FROM "sdg07"."f_7_1_2"(0,0,0,'{"subsets":
--    {}
--    }') AS OUTP;