CREATE OR REPLACE FUNCTION sdg08.f_8_10_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"age_code": {"options": ["Y_GE15"], "value": "Y_GE15"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg08.f_8_10_1';
...
--        RAISE WARNING 'JSON: %',my_query;
        ...
        SELECT format('CREATE TEMPORARY TABLE sdg_tmp_table AS (
            SELECT
			a."iso3cd" AS iso3cd
			, a.value_2013 , a.value_2017 , a.value_2007 , a.value_2011 , a.value_2012 , a.value_2010 , a.value_2009 , a.value_2014 , a.value_2004 , a.value_2005 , a.value_2015 , a.value_2018 , a.value_2019 , a.value_2006 , a.value_2008 , a.value_2016 
             , a.value_latest 
			FROM sdg08.admin0 a
			WHERE
    			indicator = ''8.10.1''
...
--        RAISE WARNING 'Using simplified table %', simplified_table_name;
        ...
        EXECUTE format('CREATE TEMPORARY TABLE mvtgeom AS (
			...
			a.iso3cd
            , CAST(h.value_2013 as FLOAT) , CAST(h.value_2017 as FLOAT) , CAST(h.value_2007 as FLOAT) , CAST(h.value_2011 as FLOAT) , CAST(h.value_2012 as FLOAT) , CAST(h.value_2010 as FLOAT) , CAST(h.value_2009 as FLOAT) , CAST(h.value_2014 as FLOAT) , CAST(h.value_2004 as FLOAT) , CAST(h.value_2005 as FLOAT) , CAST(h.value_2015 as FLOAT) , CAST(h.value_2018 as FLOAT) , CAST(h.value_2019 as FLOAT) , CAST(h.value_2006 as FLOAT) , CAST(h.value_2008 as FLOAT) , CAST(h.value_2016 as FLOAT) 
...
COMMENT ON FUNCTION sdg08.f_8_10_1 IS 'This is f_8_10_1
';

--SELECT * FROM "sdg08"."f_8_10_1"(0,0,0,'{"subsets":
--    {"age_code": {"options": ["Y_GE15"], "value": "Y_GE15"}}
--    }') AS OUTP;