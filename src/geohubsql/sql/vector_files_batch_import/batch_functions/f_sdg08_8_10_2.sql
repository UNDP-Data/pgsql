CREATE OR REPLACE FUNCTION sdg08.f_8_10_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg08.f_8_10_2';
...
COMMENT ON FUNCTION sdg08.f_8_10_2 IS 'This is f_8_10_2
';

--SELECT * FROM "sdg08"."f_8_10_2"(0,0,0,'{"subsets":
--    {"age_code": {"options": ["Y_GE15"], "value": "Y_GE15"}, "sex_code": {"options": ["M", "_T", "F"], "value": "M"}}
--    }') AS OUTP;