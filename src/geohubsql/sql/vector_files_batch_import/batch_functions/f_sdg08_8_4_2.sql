CREATE OR REPLACE FUNCTION sdg08.f_8_4_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"type_of_pr": {"options": ["MF2", "MF_AGG3B", "MF22", "MF122", "_T", "MF41", "MF3", "MF4", "MF421", "MF_AGG3A", "MF13", "MF11", "MF121", "MF413", "MF14", "MF1", "MF422", "MF21"], "value": "MF2"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg08.f_8_4_2';
...
--        RAISE WARNING 'JSON: %',my_query;
        ...
        SELECT format('CREATE TEMPORARY TABLE sdg_tmp_table AS (
            SELECT
			a."iso3cd" AS iso3cd
			, a.value_2013 , a.value_2017 , a.value_2002 , a.value_2007 , a.value_2011 , a.value_2012 , a.value_2003 , a.value_2010 , a.value_2000 , a.value_2009 , a.value_2014 , a.value_2004 , a.value_2005 , a.value_2015 , a.value_2006 , a.value_2008 , a.value_2016 , a.value_2001 
             , a.value_latest 
			FROM sdg08.admin0 a
			WHERE
    			indicator = ''8.4.2''
...
--        RAISE WARNING 'Using simplified table %', simplified_table_name;
        ...
        EXECUTE format('CREATE TEMPORARY TABLE mvtgeom AS (
			...
			a.iso3cd
            , CAST(h.value_2013 as FLOAT) , CAST(h.value_2017 as FLOAT) , CAST(h.value_2002 as FLOAT) , CAST(h.value_2007 as FLOAT) , CAST(h.value_2011 as FLOAT) , CAST(h.value_2012 as FLOAT) , CAST(h.value_2003 as FLOAT) , CAST(h.value_2010 as FLOAT) , CAST(h.value_2000 as FLOAT) , CAST(h.value_2009 as FLOAT) , CAST(h.value_2014 as FLOAT) , CAST(h.value_2004 as FLOAT) , CAST(h.value_2005 as FLOAT) , CAST(h.value_2015 as FLOAT) , CAST(h.value_2006 as FLOAT) , CAST(h.value_2008 as FLOAT) , CAST(h.value_2016 as FLOAT) , CAST(h.value_2001 as FLOAT) 
...
COMMENT ON FUNCTION sdg08.f_8_4_2 IS 'This is f_8_4_2
';

--SELECT * FROM "sdg08"."f_8_4_2"(0,0,0,'{"subsets":
--    {"type_of_pr": {"options": ["MF2", "MF_AGG3B", "MF22", "MF122", "_T", "MF41", "MF3", "MF4", "MF421", "MF_AGG3A", "MF13", "MF11", "MF121", "MF413", "MF14", "MF1", "MF422", "MF21"], "value": "MF2"}}
--    }') AS OUTP;