CREATE OR REPLACE FUNCTION sdg08.f_8_5_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"sex_code": {"options": ["M", "_T", "F"], "value": "M"}, "type_of_oc": {"options": ["ISCO88_4", "ISCO08_8", "ISCO08_1", "ISCO08_5", "ISCO88_2", "ISCO88_6", "ISCO08_X", "ISCO08_6", "ISCO08_3", "ISCO08_7", "ISCO88_X", "ISCO08_9", "ISCO08_2", "ISCO88_9", "ISCO88_5", "_T", "ISCO88_7", "ISCO08_0", "ISCO08_4", "ISCO88_8", "ISCO88_1", "ISCO88_3"], "value": "ISCO88_4"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg08.f_8_5_1';
...
--        RAISE WARNING 'JSON: %',my_query;
        ...
        SELECT format('CREATE TEMPORARY TABLE sdg_tmp_table AS (
            SELECT
			a."iso3cd" AS iso3cd
			, a.value_2013 , a.value_2017 , a.value_2012 , a.value_2011 , a.value_2009 , a.value_2014 , a.value_2018 , a.value_2015 , a.value_2019 , a.value_2016 
             , a.value_latest 
			FROM sdg08.admin0 a
			WHERE
    			indicator = ''8.5.1''
...
--        RAISE WARNING 'Using simplified table %', simplified_table_name;
        ...
        EXECUTE format('CREATE TEMPORARY TABLE mvtgeom AS (
			...
			a.iso3cd
            , CAST(h.value_2013 as FLOAT) , CAST(h.value_2017 as FLOAT) , CAST(h.value_2012 as FLOAT) , CAST(h.value_2011 as FLOAT) , CAST(h.value_2009 as FLOAT) , CAST(h.value_2014 as FLOAT) , CAST(h.value_2018 as FLOAT) , CAST(h.value_2015 as FLOAT) , CAST(h.value_2019 as FLOAT) , CAST(h.value_2016 as FLOAT) 
...
COMMENT ON FUNCTION sdg08.f_8_5_1 IS 'This is f_8_5_1
';

--SELECT * FROM "sdg08"."f_8_5_1"(0,0,0,'{"subsets":
--    {"sex_code": {"options": ["M", "_T", "F"], "value": "M"}, "type_of_oc": {"options": ["ISCO88_4", "ISCO08_8", "ISCO08_1", "ISCO08_5", "ISCO88_2", "ISCO88_6", "ISCO08_X", "ISCO08_6", "ISCO08_3", "ISCO08_7", "ISCO88_X", "ISCO08_9", "ISCO08_2", "ISCO88_9", "ISCO88_5", "_T", "ISCO88_7", "ISCO08_0", "ISCO08_4", "ISCO88_8", "ISCO88_1", "ISCO88_3"], "value": "ISCO88_4"}}
--    }') AS OUTP;