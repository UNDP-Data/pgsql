CREATE OR REPLACE FUNCTION sdg08.f_8_5_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"sex_code": {"options": ["M", "_T", "F"], "value": "M"}, "disability": {"options": ["Persons with disability", "Persons without disability", "No breakdown by disability"], "value": "Persons with disability"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg08.f_8_5_2';
...
COMMENT ON FUNCTION sdg08.f_8_5_2 IS 'This is f_8_5_2
';

--SELECT * FROM "sdg08"."f_8_5_2"(0,0,0,'{"subsets":
--    {"sex_code": {"options": ["M", "_T", "F"], "value": "M"}, "disability": {"options": ["Persons with disability", "Persons without disability", "No breakdown by disability"], "value": "Persons with disability"}}
--    }') AS OUTP;