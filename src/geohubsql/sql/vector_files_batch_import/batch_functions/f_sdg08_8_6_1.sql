CREATE OR REPLACE FUNCTION sdg08.f_8_6_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"age_code": {"options": ["Y15T24"], "value": "Y15T24"}, "sex_code": {"options": ["M", "_T", "_O", "F"], "value": "M"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg08.f_8_6_1';
...
COMMENT ON FUNCTION sdg08.f_8_6_1 IS 'This is f_8_6_1
';

--SELECT * FROM "sdg08"."f_8_6_1"(0,0,0,'{"subsets":
--    {"age_code": {"options": ["Y15T24"], "value": "Y15T24"}, "sex_code": {"options": ["M", "_T", "_O", "F"], "value": "M"}}
--    }') AS OUTP;