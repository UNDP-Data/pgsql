CREATE OR REPLACE FUNCTION sdg09.f_9_1_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"mode_of__1": {"options": ["Road transport", "Rail transport", "Air transport"], "value": "Road transport"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg09.f_9_1_2';
...
-- PL/PgSQL function to create a dynamic function layer (delivered as Vector Tiles) with filters
    ...
    BEGIN
        ...
        mode_of__1   := requested_json->'subsets'->'mode_of__1'->>'value';
...
--        RAISE WARNING 'JSON: %',my_query;
        ...
        SELECT format('CREATE TEMPORARY TABLE sdg_tmp_table AS (
            SELECT
			a."iso3cd" AS iso3cd
			, a.value_2019 , a.value_2018 , a.value_2017 
             , a.value_latest 
			FROM sdg09.admin0 a
			WHERE
    			indicator = ''9.1.2''
...
--        RAISE WARNING 'Using simplified table %', simplified_table_name;
        ...
        EXECUTE format('CREATE TEMPORARY TABLE mvtgeom AS (
			...
			a.iso3cd
            , CAST(h.value_2019 as FLOAT) , CAST(h.value_2018 as FLOAT) , CAST(h.value_2017 as FLOAT) 
...
COMMENT ON FUNCTION sdg09.f_9_1_2 IS 'This is f_9_1_2
';

--SELECT * FROM "sdg09"."f_9_1_2"(0,0,0,'{"subsets":
--    {"mode_of__1": {"options": ["Road transport", "Rail transport", "Air transport"], "value": "Road transport"}}
--    }') AS OUTP;