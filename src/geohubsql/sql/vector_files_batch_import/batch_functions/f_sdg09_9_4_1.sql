CREATE OR REPLACE FUNCTION sdg09.f_9_4_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"activity_c": {"options": ["ISIC4_C10T32X19", "_T"], "value": "ISIC4_C10T32X19"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg09.f_9_4_1';
...
COMMENT ON FUNCTION sdg09.f_9_4_1 IS 'This is f_9_4_1
';

--SELECT * FROM "sdg09"."f_9_4_1"(0,0,0,'{"subsets":
--    {"activity_c": {"options": ["ISIC4_C10T32X19", "_T"], "value": "ISIC4_C10T32X19"}}
--    }') AS OUTP;