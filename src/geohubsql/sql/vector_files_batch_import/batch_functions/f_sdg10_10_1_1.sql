CREATE OR REPLACE FUNCTION sdg10.f_10_1_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg10.f_10_1_1';
...
COMMENT ON FUNCTION sdg10.f_10_1_1 IS 'This is f_10_1_1
';

--SELECT * FROM "sdg10"."f_10_1_1"(0,0,0,'{"subsets":
--    {}
--    }') AS OUTP;