CREATE OR REPLACE FUNCTION sdg10.f_10_7_4(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg10.f_10_7_4';
...
COMMENT ON FUNCTION sdg10.f_10_7_4 IS 'This is f_10_7_4
';

--SELECT * FROM "sdg10"."f_10_7_4"(0,0,0,'{"subsets":
--    {}
--    }') AS OUTP;