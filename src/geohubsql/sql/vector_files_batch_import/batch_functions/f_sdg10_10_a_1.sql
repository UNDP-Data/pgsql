CREATE OR REPLACE FUNCTION sdg10.f_10_a_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"type_of_pr": {"options": ["AGG_AGR", "AGG_CLTH", "AGG_IND", "AGG_ARMS", "_T", "AGG_OIL", "AGG_TXT"], "value": "AGG_AGR"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg10.f_10_a_1';
...
--        RAISE WARNING 'JSON: %',my_query;
        ...
        SELECT format('CREATE TEMPORARY TABLE sdg_tmp_table AS (
            SELECT
			a."iso3cd" AS iso3cd
			, a.value_2017 , a.value_2010 , a.value_2019 , a.value_2018 , a.value_2005 , a.value_2015 , a.value_2016 
             , a.value_latest 
			FROM sdg10.admin0 a
			WHERE
    			indicator = ''10.a.1''
...
--        RAISE WARNING 'Using simplified table %', simplified_table_name;
        ...
        EXECUTE format('CREATE TEMPORARY TABLE mvtgeom AS (
			...
			a.iso3cd
            , CAST(h.value_2017 as FLOAT) , CAST(h.value_2010 as FLOAT) , CAST(h.value_2019 as FLOAT) , CAST(h.value_2018 as FLOAT) , CAST(h.value_2005 as FLOAT) , CAST(h.value_2015 as FLOAT) , CAST(h.value_2016 as FLOAT) 
...
COMMENT ON FUNCTION sdg10.f_10_a_1 IS 'This is f_10_a_1
';

--SELECT * FROM "sdg10"."f_10_a_1"(0,0,0,'{"subsets":
--    {"type_of_pr": {"options": ["AGG_AGR", "AGG_CLTH", "AGG_IND", "AGG_ARMS", "_T", "AGG_OIL", "AGG_TXT"], "value": "AGG_AGR"}}
--    }') AS OUTP;