CREATE OR REPLACE FUNCTION sdg11.f_11_1_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"location": {"options": ["U"], "value": "U"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg11.f_11_1_1';
...
--        RAISE WARNING 'JSON: %',my_query;
        ...
        SELECT format('CREATE TEMPORARY TABLE sdg_tmp_table AS (
            SELECT
			a."iso3cd" AS iso3cd
			, a.value_2010 , a.value_1995 , a.value_2000 , a.value_2014 , a.value_2018 , a.value_2005 , a.value_1990 , a.value_2016 
             , a.value_latest 
			FROM sdg11.admin0 a
			WHERE
    			indicator = ''11.1.1''
...
--        RAISE WARNING 'Using simplified table %', simplified_table_name;
        ...
        EXECUTE format('CREATE TEMPORARY TABLE mvtgeom AS (
			...
			a.iso3cd
            , CAST(h.value_2010 as FLOAT) , CAST(h.value_1995 as FLOAT) , CAST(h.value_2000 as FLOAT) , CAST(h.value_2014 as FLOAT) , CAST(h.value_2018 as FLOAT) , CAST(h.value_2005 as FLOAT) , CAST(h.value_1990 as FLOAT) , CAST(h.value_2016 as FLOAT) 
...
COMMENT ON FUNCTION sdg11.f_11_1_1 IS 'This is f_11_1_1
';

--SELECT * FROM "sdg11"."f_11_1_1"(0,0,0,'{"subsets":
--    {"location": {"options": ["U"], "value": "U"}}
--    }') AS OUTP;