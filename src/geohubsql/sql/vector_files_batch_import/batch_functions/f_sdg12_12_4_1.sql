CREATE OR REPLACE FUNCTION sdg12.f_12_4_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg12.f_12_4_1';
...
COMMENT ON FUNCTION sdg12.f_12_4_1 IS 'This is f_12_4_1
';

--SELECT * FROM "sdg12"."f_12_4_1"(0,0,0,'{"subsets":
--    {"location": {"options": ["ALLAREA"], "value": "ALLAREA"}, "education": {"options": ["_T"], "value": "_T"}, "type_of_pr": {"options": ["ALP"], "value": "ALP"}, "type_of_oc": {"options": ["isco08"], "value": "isco08"}}
--    }') AS OUTP;