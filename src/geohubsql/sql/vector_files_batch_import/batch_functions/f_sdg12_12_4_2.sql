CREATE OR REPLACE FUNCTION sdg12.f_12_4_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg12.f_12_4_2';
...
COMMENT ON FUNCTION sdg12.f_12_4_2 IS 'This is f_12_4_2
';

--SELECT * FROM "sdg12"."f_12_4_2"(0,0,0,'{"subsets":
--    {}
--    }') AS OUTP;