CREATE OR REPLACE FUNCTION sdg13.f_13_2_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg13.f_13_2_2';
...
COMMENT ON FUNCTION sdg13.f_13_2_2 IS 'This is f_13_2_2
';

--SELECT * FROM "sdg13"."f_13_2_2"(0,0,0,'{"subsets":
--    {}
--    }') AS OUTP;