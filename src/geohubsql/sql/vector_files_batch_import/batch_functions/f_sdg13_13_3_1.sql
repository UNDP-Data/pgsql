CREATE OR REPLACE FUNCTION sdg13.f_13_3_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg13.f_13_3_1';
...
COMMENT ON FUNCTION sdg13.f_13_3_1 IS 'This is f_13_3_1
';

--SELECT * FROM "sdg13"."f_13_3_1"(0,0,0,'{"subsets":
--    {}
--    }') AS OUTP;