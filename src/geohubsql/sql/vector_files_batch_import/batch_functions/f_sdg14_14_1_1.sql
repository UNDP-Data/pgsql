CREATE OR REPLACE FUNCTION sdg14.f_14_1_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"location": {"options": ["ALLAREA"], "value": "ALLAREA"}, "education": {"options": ["_T"], "value": "_T"}, "type_of_pr": {"options": ["ALP"], "value": "ALP"}, "type_of_oc": {"options": ["isco08"], "value": "isco08"}, "type_of_sp": {"options": ["ANYS"], "value": "ANYS"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg14.f_14_1_1';
...
-- PL/PgSQL function to create a dynamic function layer (delivered as Vector Tiles) with filters
    ...
    BEGIN
        ...
        education   := requested_json->'subsets'->'education'->>'value';
        type_of_pr   := requested_json->'subsets'->'type_of_pr'->>'value';
        type_of_oc   := requested_json->'subsets'->'type_of_oc'->>'value';
        type_of_sp   := requested_json->'subsets'->'type_of_sp'->>'value';
...
--        RAISE WARNING 'JSON: %',my_query;
        ...
        SELECT format('CREATE TEMPORARY TABLE sdg_tmp_table AS (
            SELECT
			a."iso3cd" AS iso3cd
			, a.value_2002 , a.value_2004 , a.value_2015 , a.value_2013 , a.value_2007 , a.value_2012 , a.value_2019 , a.value_2014 , a.value_2016 , a.value_2003 , a.value_2010 , a.value_2005 , a.value_2008 , a.value_2020 , a.value_2017 , a.value_2011 , a.value_2000 , a.value_2009 , a.value_2018 , a.value_2006 , a.value_2001 
             , a.value_latest 
			FROM sdg14.admin0 a
			WHERE
    			indicator = ''14.1.1''
			AND a.location = ''%s'' AND a.education = ''%s'' AND a.type_of_pr = ''%s'' AND a.type_of_oc = ''%s'' AND a.type_of_sp = ''%s'' 
             AND a.value_latest IS NOT NULL 
        );'
        , location , education , type_of_pr , type_of_oc , type_of_sp 
        ) INTO my_query;
...
--        RAISE WARNING 'Using simplified table %', simplified_table_name;
        ...
        EXECUTE format('CREATE TEMPORARY TABLE mvtgeom AS (
			...
			a.iso3cd
            , CAST(h.value_2002 as FLOAT) , CAST(h.value_2004 as FLOAT) , CAST(h.value_2015 as FLOAT) , CAST(h.value_2013 as FLOAT) , CAST(h.value_2007 as FLOAT) , CAST(h.value_2012 as FLOAT) , CAST(h.value_2019 as FLOAT) , CAST(h.value_2014 as FLOAT) , CAST(h.value_2016 as FLOAT) , CAST(h.value_2003 as FLOAT) , CAST(h.value_2010 as FLOAT) , CAST(h.value_2005 as FLOAT) , CAST(h.value_2008 as FLOAT) , CAST(h.value_2020 as FLOAT) , CAST(h.value_2017 as FLOAT) , CAST(h.value_2011 as FLOAT) , CAST(h.value_2000 as FLOAT) , CAST(h.value_2009 as FLOAT) , CAST(h.value_2018 as FLOAT) , CAST(h.value_2006 as FLOAT) , CAST(h.value_2001 as FLOAT) 
...
COMMENT ON FUNCTION sdg14.f_14_1_1 IS 'This is f_14_1_1
';

--SELECT * FROM "sdg14"."f_14_1_1"(0,0,0,'{"subsets":
--    {"location": {"options": ["ALLAREA"], "value": "ALLAREA"}, "education": {"options": ["_T"], "value": "_T"}, "type_of_pr": {"options": ["ALP"], "value": "ALP"}, "type_of_oc": {"options": ["isco08"], "value": "isco08"}, "type_of_sp": {"options": ["ANYS"], "value": "ANYS"}}
--    }') AS OUTP;