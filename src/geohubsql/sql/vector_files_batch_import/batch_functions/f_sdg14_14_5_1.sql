CREATE OR REPLACE FUNCTION sdg14.f_14_5_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg14.f_14_5_1';
...
COMMENT ON FUNCTION sdg14.f_14_5_1 IS 'This is f_14_5_1
';

--SELECT * FROM "sdg14"."f_14_5_1"(0,0,0,'{"subsets":
--    {}
--    }') AS OUTP;