CREATE OR REPLACE FUNCTION sdg15.f_15_5_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg15.f_15_5_1';
...
COMMENT ON FUNCTION sdg15.f_15_5_1 IS 'This is f_15_5_1
';

--SELECT * FROM "sdg15"."f_15_5_1"(0,0,0,'{"subsets":
--    {}
--    }') AS OUTP;