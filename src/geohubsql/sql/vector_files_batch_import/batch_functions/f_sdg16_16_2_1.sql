CREATE OR REPLACE FUNCTION sdg16.f_16_2_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"age_code": {"options": ["Y2T14", "Y0T14", "Y1T14", "Y1T4"], "value": "Y2T14"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg16.f_16_2_1';
...
COMMENT ON FUNCTION sdg16.f_16_2_1 IS 'This is f_16_2_1
';

--SELECT * FROM "sdg16"."f_16_2_1"(0,0,0,'{"subsets":
--    {"age_code": {"options": ["Y2T14", "Y0T14", "Y1T14", "Y1T4"], "value": "Y2T14"}}
--    }') AS OUTP;