CREATE OR REPLACE FUNCTION sdg16.f_16_2_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"age_code": {"options": ["_T"], "value": "_T"}, "sex_code": {"options": ["_T"], "value": "_T"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg16.f_16_2_2';
...
COMMENT ON FUNCTION sdg16.f_16_2_2 IS 'This is f_16_2_2
';

--SELECT * FROM "sdg16"."f_16_2_2"(0,0,0,'{"subsets":
--    {"age_code": {"options": ["_T"], "value": "_T"}, "sex_code": {"options": ["_T"], "value": "_T"}}
--    }') AS OUTP;