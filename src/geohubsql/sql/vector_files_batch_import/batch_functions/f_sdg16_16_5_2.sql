CREATE OR REPLACE FUNCTION sdg16.f_16_5_2(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg16.f_16_5_2';
...
COMMENT ON FUNCTION sdg16.f_16_5_2 IS 'This is f_16_5_2
';

--SELECT * FROM "sdg16"."f_16_5_2"(0,0,0,'{"subsets":
--    {}
--    }') AS OUTP;