CREATE OR REPLACE FUNCTION sdg16.f_16_7_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"age_code": {"options": ["Y0T45"], "value": "Y0T45"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg16.f_16_7_1';
...
COMMENT ON FUNCTION sdg16.f_16_7_1 IS 'This is f_16_7_1
';

--SELECT * FROM "sdg16"."f_16_7_1"(0,0,0,'{"subsets":
--    {"age_code": {"options": ["Y0T45"], "value": "Y0T45"}}
--    }') AS OUTP;