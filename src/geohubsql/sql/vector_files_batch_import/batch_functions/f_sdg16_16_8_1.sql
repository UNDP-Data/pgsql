CREATE OR REPLACE FUNCTION sdg16.f_16_8_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"name_of__1": {"options": ["African Development Bank", "Financial Stability Board", "Asian Development Bank", "International Bank for Reconstruction and Development", "World Trade Organisation", "UN Security Council", "Inter-American Development Bank", "UN Economic and Social Council", "UN General Assembly", "International Finance Corporation", "International Monetary Fund"], "value": "African Development Bank"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg16.f_16_8_1';
...
-- PL/PgSQL function to create a dynamic function layer (delivered as Vector Tiles) with filters
    ...
    BEGIN
        ...
        name_of__1   := requested_json->'subsets'->'name_of__1'->>'value';
...
--        RAISE WARNING 'JSON: %',my_query;
        ...
        SELECT format('CREATE TEMPORARY TABLE sdg_tmp_table AS (
            SELECT
			a."iso3cd" AS iso3cd
			, a.value_2020 , a.value_2017 , a.value_2010 , a.value_2000 , a.value_2019 , a.value_2018 , a.value_2005 , a.value_2015 , a.value_2016 
             , a.value_latest 
			FROM sdg16.admin0 a
			WHERE
    			indicator = ''16.8.1''
...
--        RAISE WARNING 'Using simplified table %', simplified_table_name;
        ...
        EXECUTE format('CREATE TEMPORARY TABLE mvtgeom AS (
			...
			a.iso3cd
            , CAST(h.value_2020 as FLOAT) , CAST(h.value_2017 as FLOAT) , CAST(h.value_2010 as FLOAT) , CAST(h.value_2000 as FLOAT) , CAST(h.value_2019 as FLOAT) , CAST(h.value_2018 as FLOAT) , CAST(h.value_2005 as FLOAT) , CAST(h.value_2015 as FLOAT) , CAST(h.value_2016 as FLOAT) 
...
COMMENT ON FUNCTION sdg16.f_16_8_1 IS 'This is f_16_8_1
';

--SELECT * FROM "sdg16"."f_16_8_1"(0,0,0,'{"subsets":
--    {"name_of__1": {"options": ["African Development Bank", "Financial Stability Board", "Asian Development Bank", "International Bank for Reconstruction and Development", "World Trade Organisation", "UN Security Council", "Inter-American Development Bank", "UN Economic and Social Council", "UN General Assembly", "International Finance Corporation", "International Monetary Fund"], "value": "African Development Bank"}}
--    }') AS OUTP;