CREATE OR REPLACE FUNCTION sdg16.f_16_9_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
    params varchar default '{
    "subsets":
    {"age_code": {"options": ["Y0", "Y0T4", "M6T59", "Y0T5", "Y0T7"], "value": "Y0"}}
    }'
    )
--    "subsets":
--    {
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg16.f_16_9_1';
...
COMMENT ON FUNCTION sdg16.f_16_9_1 IS 'This is f_16_9_1
';

--SELECT * FROM "sdg16"."f_16_9_1"(0,0,0,'{"subsets":
--    {"age_code": {"options": ["Y0", "Y0T4", "M6T59", "Y0T5", "Y0T7"], "value": "Y0"}}
--    }') AS OUTP;