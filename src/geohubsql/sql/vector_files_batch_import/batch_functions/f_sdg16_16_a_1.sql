CREATE OR REPLACE FUNCTION sdg16.f_16_a_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg16.f_16_a_1';
...
COMMENT ON FUNCTION sdg16.f_16_a_1 IS 'This is f_16_a_1
';

--SELECT * FROM "sdg16"."f_16_a_1"(0,0,0,'{"subsets":
--    {}
--    }') AS OUTP;