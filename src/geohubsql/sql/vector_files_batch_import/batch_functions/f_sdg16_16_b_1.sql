CREATE OR REPLACE FUNCTION sdg16.f_16_b_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg16.f_16_b_1';
...
COMMENT ON FUNCTION sdg16.f_16_b_1 IS 'This is f_16_b_1
';

--SELECT * FROM "sdg16"."f_16_b_1"(0,0,0,'{"subsets":
--    {"sex_code": {"options": ["M", "F", "_T"], "value": "M"}, "disability": {"options": ["Persons with disability", "Persons without disability", "No breakdown by disability"], "value": "Persons with disability"}}
--    }') AS OUTP;