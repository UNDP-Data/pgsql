CREATE OR REPLACE FUNCTION sdg04.f_4_6_1(
    z integer default 0,
    x integer default 0,
    y integer default 0,
...
RETURNS bytea AS $$
    ...
    DECLARE
        mvt bytea;
        layer_name varchar := 'sdg04.f_4_6_1';
...
COMMENT ON FUNCTION sdg04.f_4_6_1 IS 'This is dynamic subnational HDI, please insert the desired increment values';


--
--SELECT * FROM sdg04.f_4_6_1(0,0,0,'{
--  "le_incr":
--    {"value":11},
--  "eys_incr":
--     {"value":22},
...
-- example URL:
-- wget http://172.18.0.6:7800/sdg04.f_4_6_1/0/0/0.pbf?params='%7B%0A%20%20%22le_incr%22%3A%0A%20%20%20%20%7B%22value%22%3A11%7D%2C%0A%20%20%22eys_incr%22%3A%0A%20%20%20%20%20%7B%22value%22%3A22%7D%2C%0A%20%20%20%20%22mys_incr%22%3A%0A%20%20%20%20%20%7B%22value%22%3A33%7D%2C%0A%20%20%22gni_incr%22%3A%0A%20%20%20%20%20%7B%22value%22%3A44%7D%0A%7D' -O ext.pbf

-- http://172.18.0.6:7800/sdg04.f_4_6_1/{z}/{x}/{y}.pbf?params='%7B%0A%20%20%22le_incr%22%3A%0A%20%20%20%20%7B%22value%22%3A11%7D%2C%0A%20%20%22eys_incr%22%3A%0A%20%20%20%20%20%7B%22value%22%3A22%7D%2C%0A%20%20%20%20%22mys_incr%22%3A%0A%20%20%20%20%20%7B%22value%22%3A33%7D%2C%0A%20%20%22gni_incr%22%3A%0A%20%20%20%20%20%7B%22value%22%3A44%7D%0A%7D'

-- works in QGIS:
-- http://172.18.0.6:7800/sdg04.f_4_6_1/{z}/{x}/{y}.pbf?params={"le_incr":{"value":11},"eys_incr":{"value":22},"mys_incr":{"value":33},"gni_incr":{"value":44}}




--DROP VIEW IF EXISTS sdg04."f_4_6_1";
--
--CREATE VIEW sdg04."f_4_6_1" AS
--SELECT DISTINCT ON (a.geom) a.id, a.geom, s.*
--FROM admin.admin0 AS a
--INNER JOIN sdg04.admin0 AS s
--ON (a.iso3cd = s.iso3cd)
--WHERE
--s."indicator"='10.5.1' AND
--s."series" ='10_10.5.1_FI_FSI_FSKRTC';
--
--COMMENT ON VIEW sdg04."f_4_6_1" IS 'Regulatory Tier 1 capital to risk-weighted assets (%)';
...
--SELECT * FROM "sdg04"."f_4_6_1"(0,0,0,'{"subsets":
--    {"sex_code":{"value":"F"},
